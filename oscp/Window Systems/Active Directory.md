...
## SMB 
```powershell
## Port 445 open on target host
cme smb 0.0.0.0
## list shares
cme smb 0.0.0.0 --shares
## Null authentication
cme smb 0.0.0.0 -u '' -p ''
## Anonymous authentication
cme smb 0.0.0.0 -u 'anonymous' -p ''
cme smb 0.0.0.0 -u 'DoesNotExist' -p ''

## Connect to a share. -N = no password
smbclient -N //0.0.0.0/<DIR>
```
